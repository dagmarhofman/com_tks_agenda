...
$userId     = $user->get('id');
// TODO -> figure out where $this is?? DAGMAR
$listOrder  = $this->state->get('list.ordering');
$listDirn   = $this->state->get('list.direction');
$canCreate  = true; // $user->authorise('core.create', 'com_tks_agenda');
$canEdit    = true; //$user->authorise('core.edit', 'com_tks_agenda');
$canCheckin = true; //$user->authorise('core.manage', 'com_tks_agenda');
$canChange  = true; //$user->authorise('core.edit.state', 'com_tks_agenda');
$canDelete  = true; //$user->authorise('core.delete', 'com_tks_agenda');
...
<div class="modal hide fade" id="events-modal">
    ...
    <div class="modal-footer">
        <a href="#" data-dismiss="modal" class="btn">Sluit venster</a>
    </div>
</div>
