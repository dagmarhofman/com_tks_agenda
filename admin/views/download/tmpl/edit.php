...
$document->addStyleSheet(JUri::root() . 'media/com_gckloosterveen/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_gckloosterveen&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_GCKLOOSTERVEEN_TITLE_DOWNLOAD', true)); ?>
		<div class="row-fluid">
