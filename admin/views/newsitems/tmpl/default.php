...
<form action="<?php echo JRoute::_('index.php?option=com_tks_agenda&view=newsitems'); ?>" method="post"
			...
			<div class="row<?php echo $i % 2; ?>">
				...
				<dl class="article-info">
					...
					<div class="description">
 					...
 					<?php echo tks_agendaFrontendHelper::truncate($item->description,50,'</p>','...'); ?>
				</div>
 ...
 ?>
	...
	<?php if ($canCreate && $isroot == true) : ?>
		<a href="<?php echo JRoute::_('index.php?option=com_tks_agenda&task=newsitemform.edit&id=0', false, 2); ?>"
