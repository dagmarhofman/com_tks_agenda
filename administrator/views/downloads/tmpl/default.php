...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tks_agenda&task=downloads.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_tks_agenda&view=downloads'); ?>" method="post"
