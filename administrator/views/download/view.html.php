 ...
 * @since  1.6
 */
class tks_agendaViewDownload extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TKS_AGENDA_TITLE_DOWNLOAD'), 'download.png');
		...
		{
			JToolBarHelper::custom('download.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		}

		// Button for version control
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_tks_agenda.download', $this->item->id);
		}
